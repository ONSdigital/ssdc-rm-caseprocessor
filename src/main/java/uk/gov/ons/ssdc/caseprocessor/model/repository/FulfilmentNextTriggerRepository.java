...
public interface FulfilmentNextTriggerRepository extends JpaRepository<FulfilmentNextTrigger, UUID> {
    Optional<FulfilmentNextTrigger> findByTriggerDateTimeBefore(
